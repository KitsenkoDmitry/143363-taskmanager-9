...
/**
 * Рендерит компонент карточки задачи
 */
...
/**
 * Рендерит обертку для карточек board__tasks
 */
const renderBoardTasksWrapper = () => `<div class="board__tasks"></div>`;
